...
const Expenses = () => {
	...
	return (
		<div>
			{/* HEADER */}
			<div className="mb-5">
				<Header name={t.expenses} />
				<p className="text-sm text-gray-500">{t.expensesDesctiption}</p>
			</div>
			...
			<div className="flex flex-col md:flex-row justify-between gap-4">
				<div className="w-full md:w-1/3 bg-white shadow rounded-lg p-6">
					<h3 className="text-lg font-semibold mb-4">
						{t.filtersByCategoryDate}Filter by Category and Date
					</h3>
